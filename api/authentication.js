...
module.exports = (app) => {
  ...
  if (app.options.google) {
    debug('define passport 用 google 的戰略...')
    passport.use(
      new GoogleStrategy(
        {
          clientID: app.options.google.clientID,
          clientSecret: app.options.google.clientSecret,
          callbackURL: app.options.google.callbackURL,
  ...
  if (app.options.facebook) {
    passport.use(
      new FacebookStrategy(
        {
          clientID: app.options.facebook.clientID,
          clientSecret: app.options.facebook.clientSecret,
          callbackURL: app.options.facebook.callbackURL,
          profileFields: [
            'id',
            'displayName',
            'email',
  ...
  // 客戶端ID，客戶端密鑰和回調URL的選項
  if (app.options.github) {
    passport.use(new GitHubStrategy({

      clientID: app.options.github.clientID,
      clientSecret: app.options.github.clientSecret,
      callbackURL: app.options.github.callbackURL,
      scope: ['user'],
      // 如果有passReqToCallback true就比一個request比你
      passReqToCallback: true
    },
  ...
  if (app.options.twitter) {
    passport.use(
      new TwitterStrategy(
        {
          consumerKey: app.options.twitter.consumerKey,
          consumerSecret: app.options.twitter.consumerSecret,
          callbackURL: app.options.twitter.callbackURL,
          includeEmail: true,
          // 如果有passReqToCallback true就比一個request比你
          passReqToCallback: true
        },
